# -*- coding: utf-8 -*-
"""
Created on Mon Oct  7 15:27:56 2019
...
train = pd.read_csv('iris_training.csv', names=COLUMN_NAMES, header=0)
train_x, train_y = train, train.pop(y_name)

test = pd.read_csv('iris_test.csv', names=COLUMN_NAMES, header=0)
