# -*- coding: utf-8 -*-
"""
script para visualizar como segmenta los objetos el programa antes de pegarlos sobre un fondo. La segmentacion la
a aplicando un umbral automatico para eliminar el fondo BLANCO. 
Para visualizar la segmentacion, pega el objeto segmentado sobre un fondo negro. En caso de que la segmentacion 
ada deje huecos en el objetos (al tener partes blancas) es conveninete "pintar" esas partes con un editor de 
como GIMP a un color mas grisaceo para que segmente el objeto correctamente.
"""
